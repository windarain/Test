...
//                window.setAttributes(lp);
                ...
                ImageButton grey = (ImageButton) view.findViewById(R.id.grey);
                    ...
                    public void onClick(View v) {
                        switch (v.getId()) {
                            ...
                            case R.id.green:
                                ...
                                break;
                            case R.id.grey:
                                mBackgroud_Color = R.drawable.bg_grey;
                                mText.setBackgroundResource(R.drawable.bg_grey);
                                break;
                            case R.id.orange:
                                mBackgroud_Color = R.drawable.bg_orange;
                                mText.setBackgroundResource(R.drawable.bg_orange);
                                break;
                            case R.id.pink:
